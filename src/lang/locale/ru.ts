...
`,
  ...
  EXPORT_PNG_SCALE_NAME: "Масштаб экспорта PNG/WebP",
  EXPORT_PNG_SCALE_DESC: "Масштаб экспортируемых изображений PNG и WebP",
  EXPORT_WEBP_QUALITY_NAME: "Качество экспорта WebP",
  EXPORT_WEBP_QUALITY_DESC:
    "Качество WebP от 0.5 (минимальный размер) до 1 (максимальное качество). Значение по умолчанию — 0.80; оно подобрано для компактных превью галерей и карточек.",
  ...
  EXPORT_PADDING_DESC:
    "Размер (в пикселях) вокруг экспортируемого изображения SVG, PNG или WebP. Для ссылок на clippedFrame значение Отступов равно 0." +
  ...
  EXPORT_SYNC_NAME:
    "Синхронизировать имена .SVG, .PNG и/или .WebP с файлом рисунка",
  EXPORT_SYNC_DESC:
    "Если включено, плагин автоматически переименует одноимённые экспорты .SVG, .PNG и .WebP при переименовании рисунка. " +
    "При удалении рисунка эти одноимённые экспорты также будут удалены. ",
  ...
  EXPORT_SVG_DESC:
    ...
    "<code>none</code>, <code>both</code> (SVG и PNG), <code>svg</code>, <code>png</code>, <code>webp</code> и <code>all</code>.",
  EXPORT_PNG_NAME: "Автоэкспорт PNG",
  EXPORT_PNG_DESC: "То же самое, что и автоэкспорт SVG, но для *.PNG",
  EXPORT_WEBP_NAME: "Автоэкспорт WebP",
  EXPORT_WEBP_DESC:
    "Автоматически создаёт одноимённое изображение *.WebP при сохранении рисунка. WebP обычно занимает намного меньше места, чем SVG или PNG, и поддерживает прозрачность. Формат растровый и не содержит редактируемую сцену Excalidraw.",
  EXPORT_BOTH_DARK_AND_LIGHT_NAME:
    "Экспорт изображения с темной и светлой тематикой",
  EXPORT_BOTH_DARK_AND_LIGHT_DESC:
    "Если включено, Excalidraw создаст тёмный и светлый варианты для активных автоэкспортов SVG, PNG и WebP, например filename.dark.webp и filename.light.webp.",
  ...
  ERROR_WEBP_EXPORT:
    "Ошибка экспорта WebP. Уменьшите масштаб экспорта или проверьте поддержку WebP текущим браузером.",
};
